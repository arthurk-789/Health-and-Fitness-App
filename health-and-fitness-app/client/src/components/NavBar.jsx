...
function Navbar({ theme, onThemeChange }) {
  ...
  const settingsBaseLink = 'settings-link';
  const activeSettingsLink = 'settings-link--active';
  const inactiveSettingsLink = 'settings-link--inactive';
    ...
    <nav className='navbar-shell'>
      ...
      <div className='nav-controls'>
        ...
        <NavLink
          to='/settings'
          className={({ isActive }) =>
            `${settingsBaseLink} ${isActive ? activeSettingsLink : inactiveSettingsLink}`
          }
          aria-label='Settings'
        >
          <svg
